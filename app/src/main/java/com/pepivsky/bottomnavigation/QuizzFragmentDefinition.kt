...
class QuizzFragmentDefinition : Fragment(), View.OnClickListener {
    ...
    private var callback: QuizzFragmentDefinition.OnButtonListener? = null //instancia de la interface, este es asignadoa al boton
    ...
    fun setOnButtonListener(callback: QuizzFragmentDefinition.OnButtonListener) { //setter
