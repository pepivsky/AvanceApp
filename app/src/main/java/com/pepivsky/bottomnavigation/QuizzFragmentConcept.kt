...
class QuizzFragmentConcept : Fragment(), View.OnClickListener {
    ...
    private var callback: QuizzFragmentConcept.OnButtonListener? = null //instancia de la interface, este es asignadoa al boton
    ...
    fun setOnButtonListener(callback: QuizzFragmentConcept.OnButtonListener) { //setter
